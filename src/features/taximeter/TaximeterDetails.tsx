...
import { captureView } from "../../services/snapshot"
import { share } from "../../services/share"
import { Flag } from "./types/Flag"

const shareFlag = async (uri : string, flag: Flag ) => {
  
  await share({
    title: "Hi",
    url:uri,
    message: `Final price: $${flag.finalPrice}\nDistance:${flag.distance} KM\nPrice per KM: $${flag.price} \n\nRoute generated by Easyroute`,
    type:"image/png"
  })
}
...
export const TaximeterDetails = ({ route, navigation } : Props) => {  
  ...
  return <SafeAreaView className="w-full h-full bg-background">
    <View ref={viewRef} className="bg-background p-7"  collapsable={false}> 
